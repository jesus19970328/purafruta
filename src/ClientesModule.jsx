...
const db = {
  ...
  post: (t, d, tok) => fetch(`${SB_URL}/rest/v1/${t}`, { method: 'POST', headers: { ...hdr(tok), 'Content-Profile': 'public' }, body: JSON.stringify(d) }).then(r => r.json()),
  ...
  const imprimirPDF = () => {
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:32px;">
      ...
      <div style="background:#f9fafb;border-radius:12px;padding:18px;">
        ...
        ${pedido.fecha_entrega ? `<div style="display:flex;justify-content:space-between;margin-bottom:6px;font-size:13px;"><span style="color:#6b7280;">Fecha de entrega</span><span style="font-weight:600;color:#111827;">${fd(pedido.fecha_entrega)}</span></div>` : ''}
        ${pedido.zona ? `<div style="display:flex;justify-content:space-between;margin-bottom:6px;font-size:13px;"><span style="color:#6b7280;">Zona de entrega</span><span style="font-weight:600;color:#111827;">${pedido.zona}</span></div>` : ''}
